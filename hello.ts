...
let MyName:string="manahil";
console.log(`hello ${MyName}, are you from hyderabad?`);
...
let message:string='“We cannot solve problems with the kind of thinking we employed when we came up with them.”';
...
let msg:string=fav_num+"is my favourite number because it's my date of birth as well as my birthday month";
console.log(msg);
...
let me="MANAHIL";
console.log(`${me} IS AN IT SPECIALIST`);
...
let mguests: string[] = ["dua", "daniya", "aqsa","laiba","malahim"];

mguests.forEach(mguest => {
    console.log(`Dear ${mguest} you are invited on a dinner tonight at my home, so join me tonight for a cozy dinner!`);
});
let notc="aqsa";
console.log(`${notc} can't come for dinner`);
...
mguests.forEach(mguest => {
console.log(`${mguest} you are invited tonight for dinner at my home!`);
});
...
let Myguests: string[] = ["dua", "daniya", "aqsa","laiba","malahim"];
Myguests.forEach(Myguest => {
    console.log(`${Myguest} you are invited tonight for dinner at my home!`);
});

Myguests.forEach( Myguest=>{
    console.log(`${Myguest}great news!! i have found a big dinner table so please come tonight!`);
});
...
Myguests.forEach( Myguest=>{
    console.log(`${Myguest} you are invited on a dinner at my home!`);
});
...
let guests: string[] = ["dua", "daniya", "aqsa","laiba","malahim","kubra","erina hayat","fatima"];
  console.log("i can only invite two people for dinner !");

 while (guests.length >2) {
    let dltgst=guests.pop();
    console.log(`ohh ${dltgst} i am so sorry there is no space so i can't invite you`);
...
let places=["ITALY","DUBAI","SWITZERLAND","TURKEY","ICELAND"];
...
let Mine_guests: string[] = ["dua", "daniya", "aqsa","laiba","malahim"];
console.log(`hi eveyone i am invited ${Mine_guests.length} of my friends on a dinner tonight!`);
...
let languages=["TURKISH","PUSHTO","ARABIC","KOREAN"];
languages.forEach(language =>{
console.log(`i would like to speak ${language}`);
});
...
let I :{ name:string; roll_no:any; department:string }={
    name:"Manahil Rajput",
    roll_no:"BSIT_2022_072",
    department:"Information Technology"
};

console.log(`I Am ${I.name} From ${I.department} Department And My Roll Number Is ${I.roll_no}`);
...
let usernames=["admin","erina","kubra","koylu","didem"];
...
if (username.includes("admin")) {
    ...
    console.log(`assalam o alaikum ${username} thank you for logging in again!`);
}
});
...
let magicians=["David Copperfiel","Derren Brown","Criss Angel","Dynamo"];
...
let nMagicians=["David Copperfiel","Derren Brown","Criss Angel","Dynamo"];

function showmagicians(nMagicians:string[]){
    nMagicians.forEach(nMagician => {
        console.log(nMagician);
    });
}
 //show_magicians(Magicians);

function Make_great (nmagicians:string[]){
    nMagicians.forEach(nMagician =>{
        console.log(`${nMagician} the great!`);
    });
    return Make_great;
 }
...
function items(...Sandwiches:any ){
        console.log(`i want a sandwitch with ${Sandwiches}`)
}
items("cheese"," mayo");
